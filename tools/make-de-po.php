...
const ENGLISH_TO_GERMAN = [
    ...
    'Default:' => 'Standard:',
    'Course' => 'Kurs',
    'Session list with a calendar-leaf date per session, availability, and a book button.' => 'Terminliste mit Kalenderblatt-Datum je Termin, Verfügbarkeit und Buchen-Button.',
